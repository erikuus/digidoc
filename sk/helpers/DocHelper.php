...
require_once dirname(__DIR__).'/hashcode-lib/BdocContainer.php';
require_once dirname(__DIR__).'/hashcode-lib/DataFileInterface.php';
require_once dirname(__DIR__).'/hashcode-lib/DdocContainer.php';
require_once dirname(__DIR__).'/hashcode-lib/Digidoc.php';
require_once dirname(__DIR__).'/hashcode-lib/DigidocException.php';
